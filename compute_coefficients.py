...
def compute_coefficients(type_exp):
    ...
    D_Free_Inulin = 2.98e-4 # Free diffusion coefficient # mm²/s
    a_Inulin = 15.2e-7 # mm

    L_AEF = 1000.0e-6 # Width of AEF (assumed constant at the different levels)
    B_AEF = 25.0e-6 # mm can inccrease up to 1000e-6 (We assume very small because we are at the capillary level)
    beta = a_Inulin/B_AEF
